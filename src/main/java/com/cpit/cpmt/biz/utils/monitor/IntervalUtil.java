package com.cpit.cpmt.biz.utils.monitor;
...
public class IntervalUtil {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(a.isInTheInterval("-2", "(-∞,6]"));
        System.out.println(a.isInTheInterval("0.9", "[78%,98%]"));
    }
}
